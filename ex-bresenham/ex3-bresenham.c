...
GLint flag = 0, flagT = 0, pointSize = 5;
GLchar tipo = 'r', tipo2 = 'k';
...
void Keyboard (unsigned char key, int x, int y){
    ...
    case '0' :
        if(tipo2 == 'k') cor = azul;
        if(tipo2 == 'e') pointSize = 1;
        break;
    case '1' :
        if(tipo2 == 'k') cor = amarelo;
        if(tipo2 == 'e') pointSize = 1;
        break;
    case '2' :
        if(tipo2 == 'k') cor = verdeGrama;
        if(tipo2 == 'e') pointSize = 2;
        break;
    case '3' :
        if(tipo2 == 'k') cor = vermelho;
        if(tipo2 == 'e') pointSize = 3;
        break;
    case '4' :
        if(tipo2 == 'k') cor = roxo;
        if(tipo2 == 'e') pointSize = 4;
        break;
    case '5' :
        if(tipo2 == 'k') cor = laranja;
        if(tipo2 == 'e') pointSize = 5;
        break;
    case '6' :
        if(tipo2 == 'k') cor = abobora;
        if(tipo2 == 'e') pointSize = 6;
        break;
    case '7' :
        if(tipo2 == 'k') cor = cinza;
        if(tipo2 == 'e') pointSize = 7;
        break;
    case '8' :
        if(tipo2 == 'k') cor = furchsia;
        if(tipo2 == 'e') pointSize = 8;
        break;
    case '9' :
        if(tipo2 == 'k') cor = rosaBri;
        if(tipo2 == 'e') pointSize = 9;
        break;
    case 'r' :
    case 'R' :
        tipo = 'r';
